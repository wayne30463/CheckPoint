...
public class CaptureActivity extends Activity implements Callback {
	...
	private String uri = "/Checkpoint_Server/PostDataAdd";
	TextView msg_view;
	String client_idStr, server_ipStr;
	Button intent_Cam;
    AudioPlayer ap;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.client_idStr = intent.getStringExtra("client_id");  
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			...
			System.out.println("Result:"+resultString);
             final String[][] msg = {
										{"client_id", this.client_idStr},
										{"code", resultString}
									};
             Log.e("client_id", this.client_idStr);
			...
			case REFRESH_DATA:
				...
				if (result != null)
				{
					...
					if(result.compareTo("check_out") == 0){
						...
						ap.playAudio();
						viewfinderView.maskColor = Color.YELLOW;
					}
					else{
